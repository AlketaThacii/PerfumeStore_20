...
$total = 0;
?>
// Kjo faqe do të shfaqë produktet në shportë dhe do të lejojë përdoruesit të vazhdojnë te pagesa
<main class="cart-page" style="padding: 50px 10%; min-height: 60vh;">
    ...
    <?php else: ?>
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            ...
            <tbody>
              // Kjo pjesë do të iteron mbi produktet në shportë dhe do të shfaqë detajet e tyre, duke përfshirë emrin, çmimin, sasinë dhe subtotalin.
                ...
                ?>
                    ...
                    // Kjo pjesë do të përfshijë një link për të hequr produktin nga shporta, i cili do të dërgojë një kërkesë GET me veprimin "delete" dhe emrin e produktit.
                <?php endforeach; ?>
            </tbody>
        </table>
// Në fund të tabelës, do të shfaqet totali i shportës dhe një buton për të vazhduar te pagesa.
